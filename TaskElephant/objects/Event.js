...
// "Comparison methods for checking if two tasks match."
	compareEvents(event){
		...
		console.log(this.title == event.title);
		console.log(this.timeCost == event.timeCost);
		console.log(this.startTime == event.startTime);

		console.log(this.startTime);
		console.log(event.startTime);

		return(this.title  == event.title 
			&& this.timeCost == event.timeCost 
			&& this.startTime == event.startTime)
	}
	compareEventKeys(event){
